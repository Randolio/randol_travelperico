...
function CayoPlaneGuy()
	if not DoesEntityExist(planeguide) then
        ...
        planeguide = CreatePed(4, "mp_m_securoguard_01" , -1045.59, -2751.33, 20.36, 328.42, false, false)--vector4(-1045.59, -2751.33, 21.36, 328.42)
...
AddEventHandler('randol_cayoplane:client:takeplane', function()
	...
	if HasModelLoaded(planemodel) and HasModelLoaded(planeped) then
		...
		local ShamalPlane = CreateVehicle(planemodel, -1562.18, -2818.81, 13.0, true, false) --vector3(-1562.18, -2818.81, 14.0)
        ...
        DoScreenFadeOut(3000)
        Wait(10000)
        SetEntityCoords(Ped, 4453.65, -4482.5, 3.22) --vector3(4453.65, -4482.5, 4.22)
        FreezeEntityPosition(Ped, true)
        Wait(2000)
        FreezeEntityPosition(Ped, false)
        SetEntityCoords(ShamalPlane, 4452.29, -4506.29, 4.19)  --vector3(4452.29, -4506.29, 4.19)
...
function ReturnCayoPlaneGuy()
	if not DoesEntityExist(returnplaneguide) then
        ...
        returnplaneguide = CreatePed(4, "mp_m_securoguard_01" , 4436.58, -4482.53, 3.32, 210.16, false, false)--vector4(4436.58, -4482.53, 4.32, 210.16)
...
AddEventHandler('randol_cayoplane:client:return', function()
	...
	if HasModelLoaded(returnplanemodel) and HasModelLoaded(returnplaneped) then
        TriggerServerEvent('randol_cayoplane:planecooldown')
		local returnShamalPlane = CreateVehicle(returnplanemodel, 4452.09, -4506.35, 4.19, true, false) --vector3(4452.09, -4506.35, 4.19)
        ...
        DoScreenFadeOut(3000)
        Wait(10000)
        SetEntityCoords(Ped, -1038.74, -2746.61, 20.36) --vector3(-1038.74, -2746.61, 21.36)
        Wait(2000)
